...
export const PRICING_PLANS: Record<PlanType, PricingPlan> = {
  free: {
    ...
    featureList: [
      '1 compte email',
      '100 emails/mois',
      '10 réponses automatiques/semaine',
      'IA de base',
    ...
    features: {
      maxEmailAccounts: 1,
      emailsPerMonth: 100,
      autoRepliesPerMonth: 40, // ~10 par semaine
      aiEnabled: true,
  ...
  pro: {
    id: 'pro',
    name: 'Pro',
    tagline: 'Le plus populaire - Meilleur rapport qualité/prix',
    price: {
      monthly: 139,
      yearly: 1390, // -16% sur l'annuel
      currency: '€',
    },
    prices: {
      monthly: 139,
