  ...
  return (
    <section id="pricing" className="relative overflow-hidden bg-gray-50 py-32 transition-colors duration-300 dark:bg-gradient-to-br dark:from-[#0A0E27] dark:via-[#0f1629] dark:to-[#0A0E27]">
      ...
      <div className="absolute inset-0 opacity-20 pointer-events-none overflow-hidden">
        <motion.div
          className="absolute left-1/4 top-1/4 h-96 w-96 rounded-full bg-[radial-gradient(circle,rgba(34,197,94,0.4)_0%,transparent_70%)] transform-gpu"
          animate={{
            scale: [1, 1.3, 1],
            x: [0, 50, 0],
            y: [0, -30, 0],
        ...
        />
        <motion.div
          className="absolute bottom-1/4 right-1/4 h-96 w-96 rounded-full bg-[radial-gradient(circle,rgba(16,185,129,0.4)_0%,transparent_70%)] transform-gpu"
          animate={{
            scale: [1, 1.4, 1],
            x: [0, -50, 0],
            y: [0, 30, 0],
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-3 sm:px-4 lg:px-6">
        ...
        {/* Garantie satisfaction - Supprimé */}
      </div>
    </section>
  );
}
