...
export function DarkHero({ onGetStarted }: DarkHeroProps) {
  ...
  return (
    <section ref={containerRef} className="relative flex min-h-screen items-center overflow-hidden bg-transparent text-gray-900 transition-colors duration-300 dark:text-slate-50">
      <div className="absolute inset-0 z-0">
        {/* Removed solid background to show global animation */}
        <div className="absolute -left-32 top-0 h-[28rem] w-[28rem] rounded-full bg-[radial-gradient(circle,rgba(219,234,254,0.4)_0%,transparent_70%)] dark:bg-[radial-gradient(circle,rgba(59,130,246,0.15)_0%,transparent_70%)]" />
        <div className="absolute right-0 bottom-0 h-[36rem] w-[36rem] rounded-full bg-[radial-gradient(circle,rgba(219,234,254,0.3)_0%,transparent_70%)] dark:bg-[radial-gradient(circle,rgba(37,99,235,0.15)_0%,transparent_70%)]" />
      </div>
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-6 py-20 sm:px-8 lg:px-12">
        <div className="grid items-center gap-14 lg:grid-cols-2">
          ...
          <div className="relative z-20 flex flex-col items-start text-left">
            ...
            >
              ...
              <div className="flex items-center gap-2 rounded-full bg-white/80 px-4 py-2 shadow-lg shadow-blue-500/5 border border-gray-200 dark:bg-slate-800/60 dark:shadow-[0_15px_40px_rgba(59,130,246,0.2)] dark:border-slate-700/50 backdrop-blur-sm">
                ...
                <span className="text-sm font-medium text-gray-700 dark:text-slate-200">Analytics Avancés</span>
              </div>
            </motion.div>
            ...
            >
              <button
                ...
                className="group inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-blue-600 via-sky-500 to-blue-700 px-8 py-4 text-base font-semibold text-white transition-all hover:scale-105 active:scale-95 shadow-xl shadow-blue-500/20 dark:shadow-[0_20px_45px_rgba(37,99,235,0.35)]"
              >
          ...
          >
            ...
            <div className="relative w-full max-w-[90rem] lg:[perspective:2000px]">
              {/* Glow effect behind */}
              <div 
                className="pointer-events-none absolute -inset-6 rounded-[32px] bg-[radial-gradient(ellipse_at_center,rgba(59,130,246,0.2)_0%,transparent_70%)] dark:bg-[radial-gradient(ellipse_at_center,rgba(37,99,235,0.25)_0%,transparent_70%)] hidden lg:block" 
                style={{ transform: 'rotateY(-12deg) rotateX(2deg) scale(1.1)' }}
              />
              
              <div 
                className="relative overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-2xl dark:border-slate-700/50 dark:bg-slate-900 dark:shadow-[0_45px_120px_-40px_rgba(59,130,246,0.5)] hero-3d-transform"
              >
              ...
              {/* Decorative elements */}
              <div className="absolute -top-24 -right-24 h-64 w-64 rounded-full bg-[radial-gradient(circle,rgba(191,219,254,0.4)_0%,transparent_70%)] dark:bg-[radial-gradient(circle,rgba(59,130,246,0.25)_0%,transparent_70%)]" />
              <div className="absolute bottom-10 -left-16 h-56 w-56 rounded-full bg-[radial-gradient(circle,rgba(165,243,252,0.4)_0%,transparent_70%)] dark:bg-[radial-gradient(circle,rgba(37,99,235,0.2)_0%,transparent_70%)]" />
            </div>
          </motion.div>
