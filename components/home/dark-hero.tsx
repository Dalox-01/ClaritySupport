        ...
        <div className="grid items-center gap-14 lg:grid-cols-2">
          ...
          <div className="relative z-20 flex flex-col items-start text-left">
            ...
            <motion.h1
              ...
              className="mb-6 text-5xl font-bold leading-tight text-gray-900 dark:text-slate-50 sm:text-6xl lg:text-7xl"
            >
              Votre équipe <br/>
          ...
          >
            ...
            <div className="relative w-full max-w-[90rem]" style={{ perspective: '2000px' }}>
              {/* Glow effect behind */}
              <div 
              ...
              <div 
                ...
                style={{ 
                  transform: 'rotateY(-12deg) rotateX(2deg) scale(1.35) translateX(-20px)', 
