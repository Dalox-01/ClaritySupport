...
export default function MailCenterPage() {
      ...
      <div className="min-h-screen flex items-center justify-center bg-white dark:bg-black">
        <div className="text-center">
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400 font-medium">Redirection vers la connexion...</p>
          </motion.div>
        </div>
      </div>
    );
  ...
  const stats = [
    { label: 'Total emails', value: emails.length, icon: Mail, color: 'monochrome', gradient: 'from-gray-500 to-gray-600' },
    { label: 'Non lus', value: emails.filter(e => !e.is_read).length, icon: Inbox, color: 'monochrome', gradient: 'from-gray-500 to-gray-600' },
    { label: 'En attente', value: pendingReplies.length, icon: Clock, color: 'monochrome', gradient: 'from-gray-500 to-gray-600' },
    { label: 'Comptes', value: accounts.length, icon: Users, color: 'monochrome', gradient: 'from-gray-500 to-gray-600' },
  ];
            ...
            >
              <div className="space-y-1 px-4 pb-4 pt-2">
                {[
                  ...
                  { id: 'shops', label: 'Boutique', icon: Store },
            ...
            >
              <Card className={cn(
                ...
                <div className="space-y-1.5">
                  {[
                    { id: 'inbox', label: '📬 Inbox', icon: undefined },
                  ...
                  {stats.map((stat, index) => (
                    ...
                    >
                      ...
                      <div className={cn(
                        ...
                        stat.color === 'monochrome' && (isLightMode ? "from-gray-100 to-transparent" : "from-gray-800/30 to-transparent")
                      )} />
                      ...
                      <div className="relative flex items-center gap-2 z-10">
                        <motion.div
                          ...
                          className={cn(
                            ...
                            stat.color === 'monochrome' && (isLightMode ? "bg-black text-white" : "bg-white text-black")
                          )}
                        >
                          ...
                          {stat.color === 'monochrome' && <stat.icon className="w-4 h-4" />}
                        </motion.div>
                        <div className="flex-1 min-w-0">
                          <p className={cn(
            ...
            <div className="flex items-center gap-1.5 flex-wrap">
              {email.support_category && (
                <Badge variant="outline" className={cn('text-xs h-5 px-1.5', getCategoryColor(email.support_category))}>
                  {(() => {
                    const Icon = getCategoryConfig(email.support_category)?.icon;
